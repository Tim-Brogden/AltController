...
namespace AltController.Core
{
    ...
    {
        public const string FileVersion = "2.0";    // Update this when the profile file format changes
        public const string AppVersion = "2.0";    // Update this when the application version changes
