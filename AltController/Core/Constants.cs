...
namespace AltController.Core
{
    ...
    {
        public const string FileVersion = "1.98";    // Update this when the profile file format changes
        public const string AppVersion = "1.98";    // Update this when the application version changes
